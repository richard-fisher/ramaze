module Ramaze
  module Helper
    ...
    module UploadHelper
      ...
      module ClassMethods
        ...
        def upload_options(options)
          trait(
            :upload_options => Innate::Helper::UploadHelper::ClassMethods.trait[
              :default_upload_options
            ].merge(options)
          )
        end
    ...
    class UploadedFile
      ...
      # representing the filename (only the filename, not a complete path), but
      # if you provide a complete path this method it will try to identify the
      # filename and use that instead.
      #
      ...
      # to override the behavior for this particular
      # Ramaze::Helper::Upload::UploadedFile object.
      #
      # @param [String] path Path where the Ramaze::Helper::Upload::UploadedFile
      #  will be saved
      # @param [Hash] options Options for uploaded files. Options supported
      #  match those available to
      #  Ramaze::Helper::UploadHelper::ClassMethods#upload_options
      ...
      ##
      # Returns whether the Ramaze::Helper::Upload::UploadedFile has been saved
      # or not.
      #
      # @return [Boolean]
      #
